...
must_haves:
  truths:
    ...
    - "Notification type mappings are complete for new programme notification types"
  artifacts:
    ...
    - path: "src/lib/notifications.ts"
      provides: "Updated notification preference mappings for programme types"
      contains: "PROGRAMME_RENEWAL"
  key_links:
    ...
    - from: "src/lib/notifications.ts"
      to: "PROGRAMME_RENEWAL"
      via: "notification preference mapping objects include programme types"
      pattern: "PROGRAMME_RENEWAL.*emailCompliance|PROGRAMME_STATUS_CHANGE"
---
