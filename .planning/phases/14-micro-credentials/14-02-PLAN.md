...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/app/api/credentials/route.ts"
      provides: "GET endpoint for org's staff credential data"
      exports: ["GET"]
    - path: "src/app/(dashboard)/credentials/page.tsx"
      provides: "Org admin view of all staff credential statuses"
  key_links:
    ...
    - from: "src/app/(dashboard)/credentials/page.tsx"
      to: "/api/credentials"
      via: "server component data fetch or direct Prisma query"
      pattern: "prisma\\.staffMicroCredential\\.findMany|fetch.*api/credentials"
