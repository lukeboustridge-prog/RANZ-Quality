...
```
Both should return error responses with helpful messages.

Note: Positive tests (valid NZBN/name lookup returning business data) require seeded test data in the database. These will be covered by integration tests or manual verification with real member data.</verify>
