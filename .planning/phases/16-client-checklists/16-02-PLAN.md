...
1. "Templates" section:
   ...
   - If no template yet: show available master templates with a "Use This Template" button that POSTs to /api/checklists with { action: "clone", templateId } to clone it
...
2. "Project Checklists" section:
   ...
   - "Start Checklist" button: select a project (from /api/projects) and template, then POSTs to /api/checklists/[id] (created in Task 2) to create a ChecklistInstance
