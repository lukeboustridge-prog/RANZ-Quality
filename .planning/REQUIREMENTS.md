...
- [ ] **ORG-01**: Org admin can update company profile (trading name, contact details, logo, description)
- [ ] **ORG-02**: Org admin can configure organization notification preferences (which alerts, email vs SMS, frequency)
